  ...
  return (
    <section className="section pt-0">
      <div className="container-xl">
        <div className="relative px-4 py-17.5 overflow-hidden rounded-[30px]">
          <div className="text-center">
            ...
            <div className="mx-auto mt-10 h-full max-h-98.5 w-full max-w-179">
              <VideoPopup id={intro.video_id} thumbnail={intro.thumbnail} />
            </div>
          </div>
          <div className="bg-theme absolute inset-0">
            <Circle
